...
export function ReviewView({ pr, jira, loading, error, frame, width, descriptionScroll, collapsed, }) {
    const indent = 3;
    if (!pr) {
        if (error) {
