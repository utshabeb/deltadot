...
export function ReviewView({ pr, jira, loading, error, frame, width, descriptionScroll, collapsed, terminalHeight, reviewFocus, reviewFileFocusIdx, reviewExpandedFiles, reviewFilesCollapsed, reviewTab, aiReviewLoading, aiReviewError, aiScroll, }) {
    const indent = 3;
    if (!pr) {
        if (error) {
