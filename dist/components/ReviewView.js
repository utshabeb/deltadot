...
export function ReviewView({ pr, jira, loading, error, frame, width, descriptionScroll, }) {
    const indent = 3;
    if (!pr) {
        if (error) {
